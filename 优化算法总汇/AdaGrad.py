...
"""
    基本思想:如果损失对与某个给定模型参数的偏导保持相同的符号,那么学习率应该增加;
    如果偏导的符号发生了变化,那么学习率应该减少
    AdaGrad:缩放每个参数反比于所有梯度历史平方值总和的平方根,而具有小偏导数的参数在学习率上有相对较小的下降
"""
...
def AdaGrad(x, target_data, loop_max=1000,epsilon=1):
